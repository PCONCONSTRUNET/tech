...
import { Save, Code2, QrCode, PowerOff, RefreshCw, MessageSquare, X, CreditCard, CheckCircle, AlertCircle, ChevronRight, Eye, EyeOff, Zap, Globe } from 'lucide-react'
      ...
      {currentView !== 'templates' && (
        <div style={{ marginBottom: '24px' }}>
          ...
          <div style={{ display: 'flex', borderBottom: '1px solid var(--color-border)', gap: '0' }}>
            {[
              { key: 'whatsapp' as MainTab, label: 'WhatsApp', icon: <MessageSquare size={16} /> },
          ...
          <div className="card">
            <h2 style={{ fontSize: '1.125rem', fontWeight: '600', marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <span style={{ color: '#25d366' }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.19 12 19.79 19.79 0 0 1 1.12 3.33A2 2 0 0 1 3.11 1h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
              </span>
